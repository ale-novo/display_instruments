...
class InstrumentSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, name, image, position, zoom, dataref, rotate_table, translate_table_x, translate_table_y, reverse, rotate_func, translate_x_func, translate_y_func, hide_func, hide_table):
...
######## este if con OR ?  y None en lugar de "None" ##########
            ...
            if ( rotate_function is not None ) or ( translate_x_function is not  None ) or (translate_y_function is not None ) or  (hide_function is not None):
...
#                print(rotate_function, translate_x_function, translate_y_function, hide_function)
                self.refresh(rotate_function, translate_x_function, translate_y_function, hide_function)


    def refresh(self, rotate, translate_x, translate_y, hide):
...
for SPRITE in SPRITE_LIST:
    ...
    SPRITE_INSTANCE = InstrumentSprite(NAME, TEXTURE, COORD, SCALE, DATAREF, ROTATE_TABLE, TRANSLATE_X_TABLE, TRANSLATE_Y_TABLE, REVERSE, ROTATE_FUNC, TRANSLATE_X_FUNC, TRANSLATE_Y_FUNC, HIDE_FUNC, HIDE_TABLE)
