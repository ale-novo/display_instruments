...
#            values[value]=20
        ...
        while len(values) != len(DATAREFS):
            for item in list(DATAREFS-values.keys()):
                xp.AddDataRef(item)
            values = xp.GetValues() 
